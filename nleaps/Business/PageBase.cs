...
namespace nleaps
{
    public class PageBase : System.Web.UI.Page
    {
        ...
        public static nleapsContext DB
        {
            get
            {
                // http://stackoverflow.com/questions/6334592/one-dbcontext-per-request-in-asp-net-mvc-without-ioc-container
                if (!HttpContext.Current.Items.Contains("__nleapsContext"))
                {
                    HttpContext.Current.Items["__nleapsContext"] = new nleapsContext();
                }
                return HttpContext.Current.Items["__nleapsContext"] as nleapsContext;
            }
        }
