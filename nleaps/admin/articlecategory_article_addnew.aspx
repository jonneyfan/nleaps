<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="articlecategory_article_addnew.aspx.cs" Inherits="nleaps.admin.articlecategory_article_addnew" %>
    ...
    <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Items>
            <f:Grid ID="Grid1" runat="server" ShowBorder="true" ShowHeader="false" EnableCheckBoxSelect="true"
                 DataKeyNames="ID,Title" AllowSorting="true" OnSort="Grid1_Sort"
                 SortField="Title" SortDirection="DESC" AllowPaging="true" IsDatabasePaging="true"
