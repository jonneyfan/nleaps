<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="nleaps.admin._default" %>
            ...
            <f:Panel ID="Panel5" BodyPadding="5px 5px 5px 0" ColumnWidth="100%" ShowBorder="false"
                ...
                <Items>
                    <f:Panel ID="Panel3" Title="代办事宜" ColumnWidth="100%" Height="200px" runat="server"
                        CssStyle="margin-bottom:5px;" BodyPadding="5px" ShowBorder="true" ShowHeader="true"  EnableCollapse="true">
                        <Items>
