<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doc_consult.aspx.cs" Inherits="nleaps.admin.doc_consult" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" BodyPadding="5px" 
        ...
        BoxConfigPosition="Start" ShowHeader="false" Title="文件查阅">
        <Items>
            <f:Form ID="Form2" runat="server" Height="36px" BodyPadding="5px" ShowHeader="false"
                ...
                <Rows>
                    <f:FormRow ID="FormRow1" runat="server">
                        <Items>
                            <f:TwinTriggerBox ID="ttbSearchMessage" runat="server" ShowLabel="false" EmptyText="在标题中搜索"
            ...
            <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" runat="server">
                        <Items>
                            ...
                            <f:Button ID="btnNew" runat="server" Icon="Add" EnablePostBack="false" Text="新增文件查阅">
                            </f:Button>
                        </Items>
                    </f:Toolbar>
                </Toolbars>
                <Columns>
                    <f:RowNumberField />
                    <f:BoundField DataField="Name" SortField="Name" Width="100px" HeaderText="标题" />
                    ...
                    <f:BoundField DataField="Remark" ExpandUnusedSpace="true" HeaderText="发布单位" />
                    <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑" WindowID="Window1"
                        Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/admin/doc_consult_edit.aspx?id={0}"
                        Width="50px" />
