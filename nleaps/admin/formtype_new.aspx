<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formtype_new.aspx.cs" Inherits="nleaps.admin.formtype_new" %>
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false"  AutoScroll="true" runat="server">
            ...
            <Items>
                <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
                    ...
                    <Items>
                        <f:TextBox ID="tbxName" runat="server" Label="分类名称" Required="true" ShowRedStar="true">
                        </f:TextBox>
